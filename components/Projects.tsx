                  ...
                  <div className="md:flex relative z-10">
                    ...
                    <div className="relative md:w-2/5 h-64 md:h-auto overflow-hidden">
                      ...
                      <div className="absolute bottom-4 left-4 right-4 z-20 flex justify-end space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        {project.githubUrl && (
                          <a href={project.githubUrl} className={`p-2 bg-slate-950/80 rounded-full text-white transition-colors ${activeCategory !== 'Odoo'
                            ? 'hover:bg-amber-500'
                            : 'hover:bg-primary'
                            }`} title="Ver código">
                            <Github size={20} />
                        ...
                        {project.demoUrl && (
                          <a href={project.demoUrl} className={`p-2 bg-slate-950/80 rounded-full text-white transition-colors ${activeCategory !== 'Odoo'
                            ? 'hover:bg-amber-500'
                            : 'hover:bg-primary'
                            }`} title="Ver demo">
